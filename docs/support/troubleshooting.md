...
Measure the average refresh duration for the report's visuals, *including both the time that the refresh executes + the visual lag time for the visuals to update*.
